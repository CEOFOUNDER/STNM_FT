...
- `traffic-console/index.html` - private/noindex traffic-generation console for content, inbound triage, follow-up routing, outreach scoring, ad planning, UTM building and reporting.
