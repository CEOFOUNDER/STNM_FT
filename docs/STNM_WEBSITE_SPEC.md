...
- While FormSubmit remains the simple delivery path, the diagnostic may use FormSubmit's default table format and technical field names. Do not add browser-level submit interception or payload rewriting unless a full send-and-attachment regression test is completed.
